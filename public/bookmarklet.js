            ...
            if(event.data.hasOwnProperty('framePromiseID'))
            {
                switch(event.data.name)
                {
                    ...
                    case 'getTokenDetails':
                        ...
                        break;
                    case 'generateToken':
                        framePromiseWrap(generateToken(...event.data.args), event);
                        break;
                    case 'regenerateToken':
                        framePromiseWrap(regenerateToken(...event.data.args), event);
                        break;
                    case 'deleteToken':
                        framePromiseWrap(deleteToken(...event.data.args), event);
                        break;
                    case 'getUrl':
                        framePromiseReturn(event, JSON.parse(JSON.stringify(window.location)), true);
                        break;
                    case 'reload':
                        framePromiseReturn(event, {}, true);
